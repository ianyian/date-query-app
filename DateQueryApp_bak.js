...
const DateQueryApp = () => {
  ...
  const toggleGame = (game) => {
    setShowGame((prevState) => {
      const newState = { tictactoe: false, whackamole: false };
  ...
  return (
    ...
    >
      ...
      <div style={{ marginTop: "40px", textAlign: "center" }}>
        {!showGame.tictactoe && !showGame.whackamole && (
          <>
            <button
